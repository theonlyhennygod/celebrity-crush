...
var _s = I((qe) => {
  ...
  var D = zr(), uc = bs(), cc = ac((xs(), O(Ss))), rn = 1, hc = 4, vs = rn + hc, Es = d.allocUnsafe(
    ...
    constructor(e) {
      if (this.buffer = Es, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new uc.BufferReader(), (e == null ? void 0 : e.mode) === "binary")
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-4WMWERHZ.js.map
